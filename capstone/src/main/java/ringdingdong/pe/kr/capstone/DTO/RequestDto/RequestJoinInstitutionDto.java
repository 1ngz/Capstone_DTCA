...
public class RequestJoinInstitutionDto {
    ...
    @Builder
    public RequestJoinInstitutionDto(Long id, String name, String loginId, String password, String phoneNumber, String email, String institutionName, String institutionCEO, String registrationNumber, Role role) {
        this.id = id;
        this.name = name;
